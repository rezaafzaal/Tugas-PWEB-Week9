...
3. form-daftar.php (Formulir Pendaftaran - Create 1)
...
4. proses-pendaftaran.php (Proses Pendaftaran - Create 2)
...
5. list-siswa.php (Daftar Siswa - Read)
...
6. form-edit.php (Formulir Edit - Update 1)
...
7. proses-edit.php (Proses Edit - Update 2)
...
8. hapus.php (Proses Hapus - Delete)
