...
Berikut adalah penjelasan singkat fungsionalitas dari masing-masing file: <br>



I. config.php (File Konfigurasi) <br>
...
3. form_daftar.php (Formulir Pendaftaran - Create 1)<br>
...
4. proses_pendaftaran.php (Proses Pendaftaran - Create 2)<br>
...
5. list_siswa.php (Daftar Siswa - Read)<br>
...
6. form_edit.php (Formulir Edit - Update 1)<br>
...
7. proses_edit.php (Proses Edit - Update 2)<br>
